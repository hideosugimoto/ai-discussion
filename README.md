...
| モード | アイコン | レイアウト | 用途 |
|--------|----------|-----------|------|
| きっちり | ▦ | 1列縦並び、広い余白、境界線区切り、アニメなし | 正確に情報を読みたい時（デフォルト） |
| サクサク | ⚡ | 3列横並び、コンパクト、下部固定コントロール、設定省略 | ヘビーユーザー向け、最短操作 |
| リッチ | ✧ | カード型1列、シャドウ、ホバー効果、段階アニメーション | デモ・プレゼン、気持ちよく使いたい時 |

テーマ（配色）とUIモード（レイアウト構造）は独立して切り替え可能です。
