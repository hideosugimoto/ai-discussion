...
export default function RoundSection({ round, roundNum, isLatest, personas, summary }) {
  return (
    <div className="round-section" style={{ marginBottom:28 }}>
      ...
      <div className="round-messages">
        {round.messages.map((msg) => <MessageBubble key={msg.modelId} msg={msg} isNew={isLatest} persona={personas?.[msg.modelId]} stance={summary?.stances?.[msg.modelId]} />)}
      </div>
