export default function ModelBadge({ model, tag, size = "md" }) {
  const sm = size === "sm";
  return (
    <div style={{ display:"inline-flex", alignItems:"center", gap:5, padding:sm?"3px 8px":"5px 12px", borderRadius:"var(--ui-radius-pill)", background:model.bg, border:`1px solid ${model.dimColor}` }}>
